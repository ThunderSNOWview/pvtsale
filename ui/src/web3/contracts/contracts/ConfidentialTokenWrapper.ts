...
export interface ConfidentialTokenWrapperInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_transferEncrypted"
...
export interface ConfidentialTokenWrapper extends BaseContract {
  connect(runner?: ContractRunner | null): ConfidentialTokenWrapper;
  waitForDeployment(): Promise<this>;

  interface: ConfidentialTokenWrapperInterface;
